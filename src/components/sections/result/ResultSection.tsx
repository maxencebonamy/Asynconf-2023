...
const ResultSection = ({sectionRef, nextSection, loanRate, resetFields}: ResultSectionProps) => {
    ...
    return (
        <section ref={sectionRef} className="w-full h-screen flex flex-col items-center justify-start gap-4 sm:gap-16 px-4 py-16 max-w-[900px] overflow-x-hidden">
            ...
            </h2>
            {
                loanRate !== null ? (
                    <div className="flex flex-row flex-wrap items-center justify-center gap-8 relative mt-8">
                        ...
                        <IconCard className="absolute z-10 -right-12 sm:-right-24 -bottom-24 sm:-top-16">
