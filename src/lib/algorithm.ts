import { CarType, EnergyType, DistanceType, YearType, PassengersType } from "./types"

import loan_rates from "@/assets/data/loan_rates.json"
...
export const cumputeLoanRate = (
    ...
    let loanRate = loan_rates.find(e => e.scoreMin <= roundedScore && roundedScore <= e.scoreMax)?.rate
